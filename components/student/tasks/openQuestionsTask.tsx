...
interface OpenQuestionsTaskProps {
  question: Question;
  handleFlag: () => void;
...
const OpenQuestionsTask: React.FC<OpenQuestionsTaskProps> = ({
  question,
  handleFlag,
  ...
  const [textPart, questionPart] = question.text.split(", Question: ");
...
export default OpenQuestionsTask;
